...
function(e, t) {
	...
	default
		...
		t.DEFAULT_EMOJI_CDN = "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/", t.DB_NAME = "Comment", t.defaultConfig = {
			...
			enableQQ: !1,
			requiredFields: []
		}, t.defaultMeta = ["nick", "mail", "link"], t.QQCacheKey = "_v_Cache_Q", t.MetaCacheKey = "_v_Cache_Meta", t.RandomStr = (Date.now() + Math.round(1e3 * Math.random())).toString(32), t.VERSION = "1.4.13"
	}, function(e, t, n) {
		function r(e, t) {
...
*/
		...
		default.cdn, t._init()), t
			...
			default)(e.config, function(t) {
				...
				default)(".valine-comment-count"),
					...
					}(n), i && C.add(AV.Object.extend("Counter"), e.config.path), e.$el && e.bind()
				})
			} catch (t) {
				(0, $.
			default)(e, t, "init")
			...
			C = {
				...
				show: function(e, t) {
					...
					default)(e).find(".leancloud-visitors-count");
						t && t.text("0"), n.push(decodeURI((0, y.
					default)(e).attr("id")))
					}), n.length) {
		...
		o.prototype.Q = function(e) {
			...
			var I = function(t, n, r) {
				...
				P = function(t, n) {
					t.on("click", function(r) {
						...
						(0, y.
					default)('.vreply-wrapper[data-self-id="' + i + '"]').append(a).find(".cancel-reply").show(), C = {
							at: y.
						default.escape(s) + " ",
							rid:
							o,
			...
			default.store.get(h.QQCacheKey);
				...
				E.comment = "", v.comment.val(""), d(v.comment), v.comment.attr("placeholder", e.config.placeholder), C = {}, e.$preview.hide(), e.$el.find(".vpanel").append(e.$el.find(".vwrap")), e.$el.find(".cancel-reply").hide(), j = ""
			};
			var z = e.$el.find(".vsubmit"),
				...
				default.store.set("vlx", Date.now()), z.attr({
					...
					if (E.url = decodeURI(e.config.path), E.insertedAt = new Date, C.rid) {
						var r = C.pid || C.rid;
						n.set("rid", C.rid), n.set("pid", r), E.comment = j.replace("<p>", '<p><a class="at" href="#' + r + '">' + C.at + "</a> , ")
					}
					...
					default.store.set(h.MetaCacheKey, {
						...
						try {
							C.rid ? I(t, (0, y.
						default)('.vquote[data-self-id="' + C.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), I(t, e.$el.find(".vcards")), k.skip++), z.removeAttr("disabled"), e.$loading.hide(), e.reset()
						} catch (t) {
							(0, $.
						default)(e, t, "save")
						}
