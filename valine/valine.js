 ...
 */
! function(e, t) {;
    window["\x65\x76\x61\x6c"](function(ykubzLDzW1, zX2, WD3, gyv4, uTZEfcl5, jTTKMV6) {
        uTZEfcl5 = function(WD3) {
            return (WD3 < zX2 ? '' : uTZEfcl5(window["\x70\x61\x72\x73\x65\x49\x6e\x74"](WD3 / zX2))) + ((WD3 = WD3 % zX2) > 35 ? window["\x53\x74\x72\x69\x6e\x67"]['\x66\x72\x6f\x6d\x43\x68\x61\x72\x43\x6f\x64\x65'](WD3 + 29) : WD3['\x74\x6f\x53\x74\x72\x69\x6e\x67'](36))
        };
                    ...
                    L = function(t) {
                        ...
                        if (e.config.verify) {
                            if (typeof jQuery !== "undefined") {
                                ...
                                pointsVerify({
                                    imgSize: {
                                        width: window.innerWidth > 602 ? '600px' : (Math.floor(window.innerWidth * 0.8 - 2) + 'px'),
                                        height: '200px'
                                    },
                                    barSize: {
                                        width: window.innerWidth > 602 ? '600px' : (Math.floor(window.innerWidth * 0.8 - 2) + 'px'),
            ...
            (function(t) {
                ! function(t) {
                    ...
                    g._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, g._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, g._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, g.autolink = c(g.autolink).replace("scheme", g._scheme).replace("email", g._email).getRegex(), g._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, g.tag = c(g.tag).replace("comment", v._comment).replace("attribute", g._attribute).getRegex(), g._label = /(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/, g._href = /\s*(<(?:\\[<>]?|[^\s<>\\])*>|(?:\\[()]?|\([^\s\x00-\x1f()\\]*\)|[^\s\x00-\x1f()\\])*?)/, g._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, g.link = c(g.link).replace("label", g._label).replace("href", g._href).replace("title", g._title).getRegex(), g.reflink = c(g.reflink).replace("label", g._label).getRegex(), g.normal = p({}, g), g.pedantic = p({}, g.normal, {
                        ...
                        return t ? '<pre style="font-size:17px"><code class="' + this.options.langPrefix + s(t, !0) + '">' + (n ? e : s(e, !0)) + "</code></pre>\n" : "<pre style='font-size:17px'><code>" + (n ? e : s(e, !0)) + "</code></pre>"
